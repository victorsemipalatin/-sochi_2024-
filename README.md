...
4. **Дополнительные шаги:** Дополнительные шаги обработки по мере необходимости. з
5. **Запуск программы:** для запуска следует запустить файл app.py и развернуть  html форму.  
